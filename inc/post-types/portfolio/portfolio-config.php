...
if ( ! class_exists( 'WPSP_Cp_Portfolio' ) ) {
	class WPSP_Cp_Portfolio {
		...
		public function __construct() {
			...
			$this->label = $this->label ? $this->label : _x( 'Portfolio', 'Portfolio Post Type Label', 'wpsp-blog' );
		...
		public function register_post_type() {
			...
			$singular_name    = $singular_name ? $singular_name : esc_html__( 'Portfolio Item', 'wpsp-blog' );
			...
			$args = array(
				'labels' => array(
					...
					'add_new' => esc_html__( 'Add New', 'wpsp-blog' ),
					'all_items' => esc_html__( 'All ' . $name, 'wpsp-blog' ),
					'add_new_item' => esc_html__( 'Add New Item', 'wpsp-blog' ),
					'edit_item' => esc_html__( 'Edit Item', 'wpsp-blog' ),
					'new_item' => esc_html__( 'Add New Item', 'wpsp-blog' ),
					'view_item' => esc_html__( 'View Item', 'wpsp-blog' ),
					'search_items' => esc_html__( 'Search Items', 'wpsp-blog' ),
					'not_found' => esc_html__( 'No Items Found', 'wpsp-blog' ),
					'not_found_in_trash' => esc_html__( 'No Items Found In Trash', 'wpsp-blog' )
				),
				'public' => true,
		...
		public static function register_tags() {
			...
			$name = $name ? $name : esc_html__( 'Portfolio Tags', 'wpsp-blog' );
			...
			$args = array(
				'labels' => array(
					...
					'singular_name' => $name,
					'menu_name' => $name,
					'search_items' => esc_html__( 'Search','wpsp-blog' ),
					'popular_items' => esc_html__( 'Popular', 'wpsp-blog' ),
					'all_items' => esc_html__( 'All', 'wpsp-blog' ),
					'parent_item' => esc_html__( 'Parent', 'wpsp-blog' ),
					'parent_item_colon' => esc_html__( 'Parent', 'wpsp-blog' ),
					'edit_item' => esc_html__( 'Edit', 'wpsp-blog' ),
					'update_item' => esc_html__( 'Update', 'wpsp-blog' ),
					'add_new_item' => esc_html__( 'Add New', 'wpsp-blog' ),
					'new_item_name' => esc_html__( 'New', 'wpsp-blog' ),
					'separate_items_with_commas' => esc_html__( 'Separate with commas', 'wpsp-blog' ),
					'add_or_remove_items' => esc_html__( 'Add or remove', 'wpsp-blog' ),
					'choose_from_most_used' => esc_html__( 'Choose from the most used', 'wpsp-blog' ),
				),
				'public' => true,
		...
		public static function register_categories() {
			...
			$name = $name ? $name : esc_html__( 'Portfolio Categories', 'wpsp-blog' );
		...
		public static function edit_columns( $columns ) {
			if ( taxonomy_exists( 'portfolio_category' ) ) {
				$columns['portfolio_category'] = esc_html__( 'Category', 'wpsp-blog' );
			}
			if ( taxonomy_exists( 'portfolio_tag' ) ) {
				$columns['portfolio_tag']      = esc_html__( 'Tags', 'wpsp-blog' );
			}
			return $columns;
		}
		...
		public function add_page() {
			$wpsp_portfolio_editor = add_submenu_page(
				...
				esc_html__( 'Post Type Editor', 'wpsp-blog' ),
				esc_html__( 'Post Type Editor', 'wpsp-blog' ),
				'administrator',
		...
		public static function sanitize( $options ) {
			...
			add_settings_error(
				...
				esc_html__( 'Settings saved and rewrite rules flushed.', 'wpsp-blog' ),
				'updated'
			);
		...
		public static function create_admin_page() { ?>
			<div class="wrap">
				<h2><?php esc_html_e( 'Post Type Editor', 'wpsp-blog' ); ?></h2>
				<form method="post" action="options.php">
				<?php settings_fields( 'wpsp_portfolio_options' ); ?>
				<table class="form-table">
					<tr valign="top">
						<th scope="row"><?php esc_html_e( 'Admin Icon', 'wpsp-blog' ); ?></th>
						<td>
							<?php
							// Mod
					...
					<tr valign="top">
						<th scope="row"><?php esc_html_e( 'Enable Custom Sidebar', 'wpsp-blog' ); ?></th>
						<?php
						// Get checkbox value
					...
					<tr valign="top">
						<th scope="row"><?php esc_html_e( 'Include In Search', 'wpsp-blog' ); ?></th>
						<?php
						// Get checkbox value
					...
					<tr valign="top">
						<th scope="row"><?php esc_html_e( 'Post Type: Name', 'wpsp-blog' ); ?></th>
						<td><input type="text" name="wpsp_portfolio_editor[portfolio_labels]" value="<?php echo get_option( 'portfolio_labels' ); ?>" /></td>
					</tr>
					<tr valign="top">
						<th scope="row"><?php esc_html_e( 'Post Type: Singular Name', 'wpsp-blog' ); ?></th>
					...
					<tr valign="top" id="wpsp-tags-enable">
						<th scope="row"><?php esc_html_e( 'Enable Tags', 'wpsp-blog' ); ?></th>
						<?php
						// Get checkbox value
					...
					<tr valign="top" id="wpsp-tags-label">
						<th scope="row"><?php esc_html_e( 'Tags: Label', 'wpsp-blog' ); ?></th>
					...
					<tr valign="top" id="wpsp-tags-slug">
						<th scope="row"><?php esc_html_e( 'Tags: Slug', 'wpsp-blog' ); ?></th>
					...
					<tr valign="top" id="wpsp-categories-enable">
						<th scope="row"><?php esc_html_e( 'Enable Categories', 'wpsp-blog' ); ?></th>
						<?php
						// Get checkbox value
					...
					<tr valign="top" id="wpsp-categories-label">
						<th scope="row"><?php esc_html_e( 'Categories: Label', 'wpsp-blog' ); ?></th>
					...
					<tr valign="top" id="wpsp-categories-slug">
						<th scope="row"><?php esc_html_e( 'Categories: Slug', 'wpsp-blog' ); ?></th>
		...
		public static function register_sidebar() {
			...
			register_sidebar( array(
				'name'          => $post_type_name .' '. esc_html__( 'Sidebar', 'wpsp-blog' ),
